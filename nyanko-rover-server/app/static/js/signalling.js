/**
 * @brief Attempts to establish a websocket connection to the specified websocket server (1st arg)
 * - Defines 4 event handlers for websocket (onopen/onmessage/onclose/onerror)
 * - In the onopen event handler, which is called when ws connection is established,
 *   the program creates an RTCPeerConnection instance.
 * @param {*} url 
 * @param {*} onStream 
 * @param {*} onError 
 * @param {*} onClose 
